...
def editRow():
    ...
    if event_delete != ():
        ...
        event_entry.insert(0, eventId)
        timeNeeded_entry.insert(0, timeId)
        dateDue_entry.insert(0, dueId)
        priority_entry.insert(0, priorityId)
...
deleteEvents_Button = Button(eventView_Window, text = "Delete Selected Event", font = ('Courier', 14), command = deleteRow)
editEvents_Button = Button(eventView_Window, text = "Edit Event", font = ('Courier', 14), command = editRow)
